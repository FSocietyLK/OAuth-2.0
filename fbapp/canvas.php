                                ...
                                <article class='row answer-row'>
                                    <div class='col-xs-12 col-sm-12 col-md-12'>
                                        <div class='jumbotron loading-jumbotron'>
                                            <article class='row'>
                                                <div class='col-xs-12 col-sm-12 col-md-12'>
                                                    <div class='loading-gif-wrapper' id='loading_gif'>
                                                        <div class='loading-gif'>
                                                            <img src='http://cdn.meaww.com/media/images/facebook.gif' />
                                                        </div>
                                                        <div class='loading-text'>
                                                            <span id='loading-text' style='font-size: 16px'>
                                                                Loading...
                                                            </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <article class='row answer-picture-wrapper' style='padding: 0px 0px 15px'>
                                                <div class='col-sm-12 col-md-12' id='canvas-div'>
                                                    <div class='answer-picture col-xs-12' style="width:100%">
														<canvas id="canvas">
															<img id="img2" src="<?php echo $picture['url'] ?>">
															<img id="img1" src="image2.jpg">
															<script type="text/javascript">
																...
																context.fillText("<?php echo $profile['name']; ?>", 290, 300);
															</script>
														</canvas>
                                                    </div>
                                                </div>
