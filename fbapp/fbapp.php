...
<body>
    ...
    <div class='container content-container' style='padding-top: 30px'>
                ...
                <div class='col-xs-12 col-sm-8 col-md-8'>
                    <section class='col-xs-12 col-sm-12 col-md-12'>
                        <article class='row answer-row'>
                            <div class='col-xs-12 col-sm-12 col-md-12' id='answer-activity-container'>

                                <div class='jumbotron answer-activity-jumbotron' id='answer-activity-jumbotron-section' style='background-color: #FFE57F'>
                                    <article class='row question-question-wrapper' style='text-align: left'>
                                    ...
                                    <article class='row question-picture-wrapper' id='' style='padding: 0px 0px 15px'>
                                        <div class='col-xs-12 col-sm-12 col-md-12'>
                                            <div>
												<a class="question-picture" href="canvas.php">
													<img src="image2.jpg" alt="What a group of friends you have! Amazing paintings of your friendship.">
												</a>
                                            </div>
                                        </div>
                                    </article>
                                    <article class='row answer-share-wrapper'>
                                        <div class='col-xs-12 col-sm-12 col-md-12'>
                                            <table style='width:100%'>
                                                <tr>
                                                    <td class='share-call-td'>
                                                        <a class='fb-blue-button answer-share-button' href="canvas.php">
                                                            <span id='share-on-facebook-inner'>Start</span>
                                                        </a>
                                                    </td>
                                                </tr>
                                            </table>
